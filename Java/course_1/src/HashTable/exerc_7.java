...
//You are given a list of integers, myList, where some of the elements may be repeated. Your task is to write a Java
//method that removes all duplicate elements from the list and returns a new list containing only the unique elements.
...
//
//Example:
//Input: myList = [1, 2, 3, 4, 1, 2, 5, 6, 7, 3, 4, 8, 9, 5]
//
...
public class exerc_7 {
    ...
    public static List<Integer> removeDuplicates(List<Integer> input){
        Set<Integer> mySet = new HashSet<Integer>(input);
