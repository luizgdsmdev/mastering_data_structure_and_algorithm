...
# of 0 with 01, and each occurrence of 1 with 10. For example, for n = 3, the 1st row is 0, 
# the 2nd row is 01, and the 3rd row is 0110. Given two integer n and k, return the kth (1-indexed) 
