...
// -> Runtime: 0ms, beats 82.62% of submissions.
// -> Memory Usage: 41.74MB, beats 73.41% of submissions.
...
public class Summary_Ranges {
    public static List<String> summaryRanges(int[] nums) {
        ...
        if(start != end) output.add(nums[start] + "->" + nums[end]);
        else output.add(nums[start] + "");
