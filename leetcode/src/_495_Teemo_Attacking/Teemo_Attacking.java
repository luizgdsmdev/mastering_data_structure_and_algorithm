...
// -> Runtime: 0ms, beats 98.99% of submissions.
// -> Memory Usage: 44.75MB, beats 95.92% of submissions.
...
public class Teemo_Attacking {
    ...
    public static int findPoisonedDuration(int[] timeSeries, int duration) {
        ...
        for(int i = 0; i < timeSeries.length - 1; i++) {
            ...
            if(diff < duration) total -= (duration - diff);
        }
    ...
    public static void main(String[] args){
        System.out.println(findPoisonedDuration(new int[]{1,3,5}, 2));
    }
}
