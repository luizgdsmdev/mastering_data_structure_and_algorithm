...
// -> Memory Usage: 41.79MB, beats 37.62% of submissions.
...
public class Number_of_Lines_To_Write_String {
    public static int[] numberOfLines(int[] widths, String s) {
        ...
        for(char letter: s.toCharArray()){
            int letterValue = widths[letter - 'a'];
            if(tempSum + letterValue <= 100){
                tempSum += letterValue;
            }else if(tempSum + letterValue > 100){
                count++;
                tempSum = letterValue;
            }
        }
        ...
        return new int[]{count, tempSum};
    }


    public static void main(String[] args){
        String value = "abcdefghijklmnopqrstuvwxyz";
        numberOfLines(new int[]{4,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10}, value);
    }
}
