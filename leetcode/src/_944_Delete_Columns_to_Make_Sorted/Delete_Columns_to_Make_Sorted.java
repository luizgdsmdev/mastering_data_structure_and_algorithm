package _944_Delete_Columns_to_Make_Sorted;
...
// -> Runtime: 7ms, beats 90.91% of submissions.
// -> Memory Usage: 44.48MB, beats 56.02% of submissions.
...
public class Delete_Columns_to_Make_Sorted {
    ...
    public static void main(String[] args){
        minDeletionSize(new String[]{"abc", "bce", "cae"});
    }
}
